...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
    ...
    {{-- Measures Selection (Future Enhancement) --}}
    {{--
    <div class="md:col-span-3 mt-4 border-t pt-4">
        <h3 class="text-lg font-medium mb-2">{{ __('Control Measures') }}</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
         ...
         <div class="text-right mt-2">
            <x-bladewind::button size="tiny" tag="a" href="{{ route('measures.create') }}" target="_blank">{{ __('Add New Measure') }}</x-bladewind::button>
        </div>
    </div>
    --}}
